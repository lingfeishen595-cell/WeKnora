...
type UserService interface {
	...
	// LoginWithGoocan exchanges a Goocan-authenticated identity into local WeKnora tokens.
	LoginWithGoocan(ctx context.Context, req *types.GoocanExchangeRequest) (*types.LoginResponse, error)
