...
const exampleData: FAQEntryPayload[] = [
  {
    standard_question: '什么是 DataGoocan？',
    answers: ['DataGoocan 是一个智能知识库管理系统', '它支持多种知识库类型和导入方式'],
    similar_questions: ['DataGoocan 是什么？', '介绍一下 DataGoocan'],
    negative_questions: ['这不是 DataGoocan', '与 DataGoocan 无关'],
    tag_name: '产品介绍',
  },
  {
