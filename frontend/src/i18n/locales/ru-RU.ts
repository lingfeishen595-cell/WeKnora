export default {
  ...
  newUserGuide: {
    ...
    steps: {
      welcome: {
        title: 'Добро пожаловать в DataGoocan',
      ...
      knowledge: {
        ...
        desc: 'С этого всё начинается: загружайте документы, веб-страницы или FAQ, и DataGoocan автоматически разберёт и проиндексирует их. Нажмите здесь, чтобы открыть базы знаний.',
      },
      chat: {
      ...
      settings: {
        ...
        desc: 'Откройте это меню, чтобы управлять аккаунтом, участниками и системными настройками. Здесь же можно в любой момент снова открыть это обучение.',
      },
      models: {
        ...
        title: 'Всё готово',
        desc: 'Теперь вы знаете основы — начните создавать своего помощника на основе знаний! Вернуться к обучению можно в любой момент из меню пользователя.',
      },
    },
  },
  batchManage: {
  ...
  settings: {
    ...
    weknoraCloud: {
      title: 'DataGoocan Cloud',
      description: 'Настройте учётные данные APPID и APPSECRET для DataGoocan Cloud. Данные используются для модельных сервисов и движка парсинга документов.',
      ...
      expired: 'Учётные данные DataGoocan Cloud истекли',
      ...
      appIdLabel: 'APPID',
      appIdDesc: 'ID приложения DataGoocan Cloud',
      appIdPlaceholder: 'Введите APPID',
      appSecretLabel: 'APPSECRET',
      appSecretDesc: 'Секрет приложения DataGoocan Cloud',
      ...
      usageSteps: '1. Заполните и сохраните APPID и APPSECRET\n2. Модели: перейдите в управление моделями, добавьте модель с источником Remote API, выберите DataGoocan Cloud\n3. Парсинг документов: перейдите в настройки базы знаний → движок парсинга, выберите DataGoocan Cloud для нужных типов файлов',
      fillRequired: 'Заполните APPID и APPSECRET',
      saveSuccess: 'Учётные данные сохранены',
      saveFailed: 'Не удалось сохранить данные',
      credentialConfigured: 'Учётные данные DataGoocan Cloud настроены.',
      credentialExpired: 'Данные истекли. Перенастройте.',
      credentialUnconfigured: 'Учётные данные DataGoocan Cloud не настроены. Заполните APPID и APPSECRET.',
      checkingStatus: 'Проверка статуса...',
      goToSettings: 'Перейти в настройки',
      modelHintConfigured: 'Учётные данные DataGoocan Cloud настроены. Поддерживаемые модели см. в',
    ...
    storage: {
      ...
      pathPrefixPlaceholder: 'напр. datagoocan/images',
      prefixPlaceholder: 'напр. datagoocan',
...
/example\.(net|org)/`,
  ...
  initialization: {
    title: 'Инициализация',
    welcome: 'Добро пожаловать в DataGoocan',
  ...
  auth: {
    ...
    inviteGoocanSubtitle: 'Войдите с учетной записью Goocan, чтобы присоединиться к этому пространству',
    inviteGoocanJoin: 'Войти через Goocan и присоединиться',
    inviteGoocanJoining: 'Присоединение...',
    goocanLoginDisabled: 'Вход через Goocan не включен. Обратитесь к администратору.',
    haveAccount: 'Уже есть аккаунт?',
    noAccount: 'Ещё нет аккаунта?',
    backToLogin: 'Вернуться ко входу',
    registerNow: 'Зарегистрироваться',
    loginHint: 'Войдите, чтобы продолжить, или создайте аккаунт ниже, если вы впервые здесь.',
    firstTime: 'Впервые в DataGoocan?',
  ...
  system: {
    ...
    versionDescription: 'Версия сервиса приложения (DataGoocan app)',
    frontendVersionLabel: 'Версия UI',
    frontendVersionDescription: 'Версия сборки UI (DataGoocan UI)',
    ...
    dbMigrationFailedDesc: 'Миграция базы данных при запуске не завершилась успешно. Часть таблиц или индексов могла не создаться, из-за чего Wiki, граф знаний и другие функции могут не работать. Проверьте логи backend и состояние миграции базы данных, затем повторите попытку.',
  ...
  createChat: {
    title: 'Привет, я DataGoocan — ваши знания всегда под рукой',
  ...
  kbSettings: {
    ...
    parser: {
      ...
      engines: {
        ...
        weknoracloud: {
          name: 'DataGoocan Cloud',
          desc: 'Парсинг документов через DataGoocan Cloud',
        },
        markitdown: {
          name: 'MarkItDown',
