export default {
  ...
  newUserGuide: {
    ...
    steps: {
      ...
      settings: {
        title: "계정 및 설정 입구",
        desc: "여기를 열면 계정, 멤버, 시스템 설정을 관리할 수 있습니다. 이 가이드도 이 메뉴에서 언제든 다시 열 수 있습니다.",
      },
      models: {
        title: "모델 구성하기",
        ...
        title: "준비 완료",
        desc: "핵심 기능을 모두 익혔습니다. 이제 나만의 지식 어시스턴트를 만들어 보세요! 사용자 메뉴에서 언제든 가이드를 다시 볼 수 있습니다.",
      },
    },
  },
  batchManage: {
  ...
  settings: {
    ...
    weknoraCloud: {
      ...
      description: 'DataGoocan Cloud APPID 및 APPSECRET 자격 증명을 설정합니다. 자격 증명은 모델 서비스와 문서 파싱 엔진에 사용됩니다.',
      viewDocs: '문서 보기',
      unconfigured: '자격 증명이 설정되지 않았습니다. APPID와 APPSECRET을 입력하세요.',
      configured: '자격 증명이 설정되었으며 정상 작동 중입니다.',
      expired: 'DataGoocan Cloud 자격 증명 만료',
      expiredDefault: '서비스 재시작 후 암호화 키가 변경되어 저장된 자격 증명을 복호화할 수 없습니다. 다시 입력하세요.',
      reconfigure: '재설정',
      appIdLabel: 'APPID',
      appIdDesc: 'DataGoocan Cloud 애플리케이션 ID',
      appIdPlaceholder: 'APPID 입력',
      appSecretLabel: 'APPSECRET',
      appSecretDesc: 'DataGoocan Cloud 애플리케이션 비밀키',
      appSecretPlaceholder: 'APPSECRET 입력',
      saveHint: '저장 전 서비스 연결 가능 여부를 확인하고 암호화하여 저장합니다.',
      saveBtn: '자격 증명 저장',
      usageTitle: '사용 가이드',
      usageSteps: '1. 이 페이지에서 APPID와 APPSECRET을 입력하고 저장\n2. 모델 서비스: 모델 관리에서 Remote API 소스로 모델 추가, 공급자로 DataGoocan Cloud 선택\n3. 문서 파싱: 지식 베이스 설정 → 파싱 엔진에서 해당 파일 유형에 DataGoocan Cloud 엔진 선택',
      fillRequired: 'APPID와 APPSECRET을 입력하세요',
      saveSuccess: '자격 증명 저장 완료',
      saveFailed: '자격 증명 저장 실패',
      credentialConfigured: 'DataGoocan Cloud 자격 증명이 설정되었습니다.',
      credentialExpired: '자격 증명이 만료되었습니다. 재설정하세요.',
      credentialUnconfigured: 'DataGoocan Cloud 자격 증명이 설정되지 않았습니다. APPID와 APPSECRET을 먼저 설정하세요.',
      checkingStatus: '자격 증명 상태 확인 중...',
      goToSettings: '설정으로 이동',
      modelHintConfigured: 'DataGoocan Cloud 자격 증명이 설정되었습니다. 지원 모델은',
    ...
    storage: {
      ...
      pathPrefixPlaceholder: '예: datagoocan/images',
      prefixPlaceholder: '예: datagoocan',
  ...
  initialization: {
    title: "초기화",
    welcome: "DataGoocan에 오신 것을 환영합니다",
  ...
  system: {
    ...
    retry: "재시도",
    versionLabel: "앱 버전",
    versionDescription: "애플리케이션 서비스(DataGoocan app)의 버전 번호",
    frontendVersionLabel: "UI 버전",
    frontendVersionDescription: "UI(DataGoocan UI) 빌드 버전 번호",
    ...
    dbMigrationFailedDesc: "시작 시 데이터베이스 마이그레이션이 정상적으로 완료되지 않았습니다. 일부 테이블이나 인덱스가 생성되지 않았을 수 있으며, Wiki와 지식 그래프 기능 등이 동작하지 않을 수 있습니다. 백엔드 로그와 데이터베이스 마이그레이션 상태를 확인한 뒤 다시 시도하세요.",
  ...
  createChat: {
    title: "안녕하세요, DataGoocan입니다 — 당신의 지식을 손끝에",
    ...
    parser: {
      ...
      engines: {
        ...
        weknoracloud: {
          ...
          desc: 'DataGoocan Cloud를 통한 문서 파싱',
        },
        markitdown: {
          name: 'MarkItDown',
