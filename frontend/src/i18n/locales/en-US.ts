export default {
  ...
  settings: {
    ...
    weknoraCloud: {
      ...
      description: 'Configure DataGoocan Cloud APPID and APPSECRET credentials. Credentials are used for model services and document parsing engine.',
      viewDocs: 'View Docs',
      unconfigured: 'Credentials not configured. Please fill in APPID and APPSECRET.',
      configured: 'Credentials configured and working.',
      expired: 'DataGoocan Cloud credentials expired',
      ...
      appIdLabel: 'APPID',
      appIdDesc: 'DataGoocan Cloud application ID',
      appIdPlaceholder: 'Enter APPID',
      appSecretLabel: 'APPSECRET',
      appSecretDesc: 'DataGoocan Cloud application secret',
      ...
      usageSteps: '1. Fill in and save APPID and APPSECRET on this page\n2. Model services: Go to Model Management, add a model with Remote API source, select DataGoocan Cloud as provider\n3. Document parsing: Go to Knowledge Base Settings → Parser Engine, select DataGoocan Cloud engine for desired file types',
      ...
      credentialConfigured: 'DataGoocan Cloud credentials configured.',
      credentialExpired: 'Credentials expired. Please reconfigure.',
      credentialUnconfigured: 'DataGoocan Cloud credentials not configured. Please set up APPID and APPSECRET first.',
      checkingStatus: 'Checking credential status...',
      goToSettings: 'Go to Settings',
      modelHintConfigured: 'DataGoocan Cloud credentials configured. See supported models in',
    ...
    storage: {
      ...
      pathPrefixPlaceholder: 'e.g. datagoocan/images',
      prefixPlaceholder: 'e.g. datagoocan',
  ...
  createChat: {
    title: 'Hi, I am DataGoocan — your knowledge, within reach',
...
\
  ...
  system: {
    ...
    versionDescription: 'Version of the application service (DataGoocan app)',
    frontendVersionLabel: 'UI Version',
    frontendVersionDescription: 'Build version of the UI (DataGoocan UI)',
    ...
    dbMigrationFailedDesc: 'The startup database migration did not complete successfully. Some tables or indexes may be missing, which can break Wiki ingest, the knowledge graph, and other features. Check backend logs and database migration state, then retry.',
    ...
    parser: {
      ...
      engines: {
        ...
        weknoracloud: {
          ...
          desc: 'Document parsing via DataGoocan Cloud',
        },
        markitdown: {
          name: 'MarkItDown',
