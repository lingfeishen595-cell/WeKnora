export default {
  ...
  newUserGuide: {
    ...
    steps: {
      welcome: {
        title: "欢迎使用 DataGoocan",
        desc: "只需几步，带你快速了解知识库、对话与智能体的核心用法。点击「下一步」开始。",
      },
      knowledge: {
        title: "创建你的知识库",
        desc: "知识库是一切的起点：上传文档、网页或 FAQ，DataGoocan 会自动解析并建立索引。点击这里进入知识库。",
      },
      chat: {
        title: "发起智能对话",
  ...
  settings: {
    ...
    roleDenied: {
      ...
      description: "配置 DataGoocan Cloud 的 APPID 和 APPSECRET 凭证。凭证用于模型服务和文档解析引擎。",
      viewDocs: "查看文档",
      unconfigured: "尚未配置凭证，请填写 APPID 和 APPSECRET",
      configured: "凭证已配置，状态正常",
      expired: "DataGoocan Cloud 凭证已失效",
      expiredDefault: "服务重启后加密密钥已变更，已保存的凭证无法解密。请重新填写凭证。",
      reconfigure: "重新配置",
      appIdLabel: "APPID",
      appIdDesc: "DataGoocan Cloud 的应用 ID",
      appIdPlaceholder: "请输入 APPID",
      appSecretLabel: "APPSECRET",
      appSecretDesc: "DataGoocan Cloud 的应用密钥",
      appSecretPlaceholder: "请输入 APPSECRET",
      saveHint: "保存后将验证服务可达性并加密存储凭证",
      saveBtn: "保存凭证",
      usageTitle: "使用说明",
      usageSteps: "1. 在此页面填写并保存 APPID 和 APPSECRET\n2. 模型服务：前往「模型管理」添加模型，选择 Remote API 来源，厂商选择「DataGoocan Cloud」\n3. 文档解析：前往「知识库设置 → 解析引擎」，为对应文件类型选择「DataGoocan Cloud」引擎",
      fillRequired: "请填写 APPID 和 APPSECRET",
      saveSuccess: "凭证保存成功",
      saveFailed: "凭证保存失败",
      credentialConfigured: "DataGoocan Cloud 凭证已配置",
      credentialExpired: "凭证已失效，请重新配置。",
      credentialUnconfigured: "尚未配置 DataGoocan Cloud 凭证，请先填写 APPID 和 APPSECRET。",
      checkingStatus: "正在检查凭证状态...",
      goToSettings: "前往设置中配置",
      modelHintConfigured: "DataGoocan Cloud 凭证已配置。支持的模型可参考",
    ...
    storage: {
      ...
      configurable: "可配置",
      pathPrefix: "路径前缀（可选）",
      pathPrefixPlaceholder: "如 datagoocan/images",
      prefixPlaceholder: "如 datagoocan",
  ...
  inviteRegister: {
    ...
    bannerHint: "使用 Goocan 账号登录后将自动加入该团队。",
    loading: "正在校验邀请链接…",
  ...
  auth: {
    ...
    inviteGoocanSubtitle: "使用 Goocan 账号登录后将自动加入该空间",
    inviteGoocanJoin: "Goocan 登录并加入",
    inviteGoocanJoining: "正在加入...",
    goocanLoginDisabled: "Goocan 登录未启用，请联系管理员。",
    haveAccount: "已有账户？",
    noAccount: "还没有账户？",
    backToLogin: "返回登录",
    registerNow: "立即注册",
    loginHint: "登录以继续使用；首次使用请在下方创建账户。",
    firstTime: "首次使用 DataGoocan？",
  ...
  system: {
    ...
    retry: "重试",
    versionLabel: "应用版本",
    versionDescription: "当前应用服务（DataGoocan app）的版本号",
    frontendVersionLabel: "UI 版本",
    frontendVersionDescription: "当前 UI 界面（DataGoocan UI）的构建版本号",
    ...
    dbMigrationFailedDesc: "启动时数据库迁移未成功完成，部分表或索引可能未创建，会导致 Wiki、知识图谱等功能异常。请检查后端日志和数据库迁移状态后再重试。",
  ...
  createChat: {
    title: "Hi，我是 DataGoocan，让你的知识触手可及",
    newSessionTitle: "新会话",
    messages: {
    ...
    parser: {
      ...
      engines: {
        ...
        weknoracloud: {
          ...
          desc: "使用 DataGoocan Cloud 进行文档解析",
        },
        markitdown: {
          name: "MarkItDown",
  ...
  tenantMember: {
    title: "成员管理",
    sectionDescription: "从 Goocan 选择伙伴加入当前空间并分配角色。只有 Owner 可以新增或移除成员。",
    ...
    add: {
      ...
      searchResults: "Goocan 人员",
      noGoocanUsers: "暂无可添加人员",
      searchTypeLabel: "搜索类型",
      searchTypeName: "姓名",
      searchTypeWorkNumber: "工号",
      searchTypeDepartment: "部门",
      departmentTitle: "部门",
      nextLevel: "下级",
      selectedTitle: "已选择",
      selectedUsers: "已选 {count} 人",
      selectedEmpty: "请从左侧选择人员",
      alreadyInSpace: "已在空间",
      confirmAdd: "确认添加",
      selectRequired: "请先选择成员",
      maxSelected: "一次最多选择 {max} 人",
      goocanSearchFailed: "Goocan 人员查询失败",
      batchAddFailed: "添加成员失败",
      batchAddSummary: "成功添加 {added} 人，{already} 人已在空间，{failed} 人失败",
      submit: "添加",
      success: "已添加成员",
    },
    remove: {
